<?php
/**
 * Template Name: Giao diện Trang Sự kiện năm
 */
get_header(); ?>

<div class="news-page-container">
    <?php if (function_exists('adv_display_breadcrumb')) { adv_display_breadcrumb(); } ?>
    <h1 class="news-page-title"><?php adtec_label('su_kien_nam'); ?></h1>

    <!-- ========================================== -->
    <!-- PHẦN 1: SLIDER SỰ KIỆN NĂM NỔI BẬT (CPT: su_kien_nam)  -->
    <!-- ========================================== -->
    <?php
    $current_lang = function_exists('pll_current_language') ? pll_current_language() : 'vi';

    $featured_query = new WP_Query(array(
        'post_type'      => 'su_kien_nam',
        'posts_per_page' => 9,
        'lang'           => $current_lang,
    ...
    <!-- ========================================== -->
    <!-- PHẦN 2: DANH SÁCH SỰ KIỆN NĂM (CPT: su_kien_nam)-->
    <!-- ========================================== -->
    <div class="latest-news-section">
        <h2 class="section-news-title"><?php adtec_label('su_kien_moi'); ?></h2>
