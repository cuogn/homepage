...
<div class="news-detail-wrapper">
    ...
    $news_slug = adtec_get_label('slug_sukiennam');

    // 3. Tạo link trang Sự kiện năm chuẩn đa ngôn ngữ (Ví dụ: .../en/news/ hoặc .../ja/news-ja/)
    ...
    if ( have_posts() ) :
        while ( have_posts() ) : the_post(); 
            ...
            $custom_date = get_post_meta(get_the_ID(), 'events_date', true);
            ...
            $raw_gallery = rwmb_meta( 'events_gallery', array( 'size' => 'large' ) );
